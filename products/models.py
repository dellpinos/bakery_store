...
class Product(models.Model):
    ...
    def __str__(self):
        return f"The product id: {self.id}, name: {self.name}, total price: {self.total_price}, seller: {self.seller_user}"
...
class Ingredient(models.Model):
    ...
    def __str__(self):
        return f"The ingredient id: {self.id}, name: {self.name}, price: {self.price} - quantity: {self.quantity}, availability: {self.availability}"
